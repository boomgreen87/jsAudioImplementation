(() => {
      ...
      bullets.forEach((bullet, index) => {
        ...
        squares.forEach((square, index) => {
          ...
          if (bullet.y <= (square.y + square.y2) && bullet.y > square.y && bullet.x > square.x && bullet.x < (square.x + square.x2)) {
            ...
            let explosion = document.createElement('audio'); //Creates an <audio></audio> element
            explosion.src = "audio/HITMARKER.mp3";
  ...
  function createBullet() {
    ...
    let laser = document.createElement('audio'); //Creates an <audio></audio> element
    laser.src = "audio/intervention.mp3";
